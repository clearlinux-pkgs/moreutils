...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1599157249
...
cp %{_builddir}/moreutils-0.62/COPYING %{buildroot}/usr/share/package-licenses/moreutils/4d1d37f306ed270cda5b2741fac3abf0a7b012e5
cp %{_builddir}/moreutils-0.62/debian/copyright %{buildroot}/usr/share/package-licenses/moreutils/a64a131d9ade2f0f8270db628aa0f845ca89a1ec
%make_install
